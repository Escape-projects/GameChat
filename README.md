...
**Дипломный проект, демонстрирующий построение **распределённой системы** для обмена текстовыми сообщениями в реальном времени. Это полноценный игровой мессенджер с поддержкой личных сообщений, тематических комнат по играм и системы друзей.**
